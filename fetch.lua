...
function fetchData(fromSection, values, whereData, whereValue) -- fromSection: str, values: table, whereName: str, whereValue: str
    buildConnection()
    if not whereData then whereData = '' end 
    if not whereValue then whereValue = '' end
    ...
    for a, b in pairs(returnValues) do 
